...
package sandra.examples.vpa.jack;
...
/**
 * JACK: Jack is a general-purpose VPA which knowledge base is encoded in AIML. 
 * 
 * See Jack in Pandorabots: http://www.pandorabots.com/pandora/talk?botid=d7b695cf0e344c0a
 * 
 ...
 *
 */
public class Jack extends ASR {
	private static final String LOGTAG = "JACK";
	private static final String BOTID = "d7b695cf0e344c0a";
	...
	public void onBackPressed() {
	    super.onBackPressed();
	    Intent intent=new Intent(getBaseContext(),Jack.class);       	
