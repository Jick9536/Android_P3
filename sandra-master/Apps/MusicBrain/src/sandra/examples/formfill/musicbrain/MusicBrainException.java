...
/**
* Exception class that allows a more fine-grained management of exceptions providing
...
*
*/
class MusicBrainException extends Exception{
	private static final long serialVersionUID = 2L;
	
	private String reason;

	MusicBrainException(String message){
		super(message);
	}

	MusicBrainException(String message, String reason){
		super(message);
		this.reason = reason;
	}
